...
mutators = [removeElements, addElements, changeValueOfFirstElement, changeValueOfAnyElement, reverseList]

--mutators = [changeValueOfAnyElement, changeValueOfFirstElement]
