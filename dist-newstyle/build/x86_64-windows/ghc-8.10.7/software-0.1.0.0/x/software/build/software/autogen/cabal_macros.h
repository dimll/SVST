...
/* package software-0.1.0.0 */
#ifndef VERSION_software
#define VERSION_software "0.1.0.0"
#endif /* VERSION_software */
#ifndef MIN_VERSION_software
#define MIN_VERSION_software(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_software */
...
#define CURRENT_COMPONENT_ID "software-0.1.0.0-inplace-software"
